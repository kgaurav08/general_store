...
function addCandy(e) {
  ...
  if (
    ...
    axios
      .post(
        `https://crudcrud.com/api/c9cb1e86e83249329e088e9a6038858a/CandyStock`,
        candies
      )
      .then((response) => {
...
function showCandies() {
  ...
  axios
    .get(`https://crudcrud.com/api/c9cb1e86e83249329e088e9a6038858a/CandyStock`)
    .then((response) => {
...
const buyOne = async (id, candyName, description, price, quantity) => {
  await axios
    .put(
      `https://crudcrud.com/api/c9cb1e86e83249329e088e9a6038858a/CandyStock/${id}`,
